<template>
	<div class="unitsClouds">
		<el-row type='flex' justify='end' class='rowTop'>
      <el-form size='mini'>
        <el-form-item>
          <el-button type='info' size='small' @click='addUnits'
          style='background-color:#448db8;border:none;'>新增</el-button>
        </el-form-item>
      </el-form>
		</el-row>
		<el-table :data="unitCloudTree" border :max-height="height" size='mini' stripe class='tableUnitCloud'>
      <el-table-tree-column fixed :expandAll='false' file-icon="fa fa-file" folder-icon="fa fa-folder" label="单位名称" min-width="220">
